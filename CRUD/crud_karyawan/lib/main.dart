...
import 'package:crud_karyawan/details.dart';
import 'package:crud_karyawan/newdata.dart';
...
class _HomeState extends State<Home> {
  Future<List> getData() async {
    var url = Uri.parse('http://localhost/API_PAM/P5/list.php');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "PHP MySQL CRUD KEFAS 20210120001",
